...
public class WebFluxFunctionalEndpointsDefinitionsTest {
	...
	@Test
	void testFluxStaticSimpleMethodRoute() throws Exception {
		String routerMethod = """
			@Bean
        ...
        assertEquals("org.test.webflux.HandlerImplementation", route.getHandlerClass());
        assertEquals("public Mono<org.springframework.web.reactive.function.server.ServerResponse> getPerson(org.springframework.web.reactive.function.server.ServerRequest)", route.getHandlerMethod());
	}

	@Test
	void testFluxBuilderSimpleMethodRoute() throws Exception {
		String routerMethod = """
			@Bean
	...
	@Test
	void testFluxStaticMultipleRoutesWithDifferentMethods() throws Exception {
		String routerMethod = """
			@Bean
        ...
        assertEquals("org.test.webflux.HandlerImplementation", route1.getHandlerClass());
        assertEquals("public Mono<org.springframework.web.reactive.function.server.ServerResponse> getPerson(org.springframework.web.reactive.function.server.ServerRequest)", route1.getHandlerMethod());
        ...
        assertEquals("org.test.webflux.HandlerImplementation", route2.getHandlerClass());
        assertEquals("public Mono<org.springframework.web.reactive.function.server.ServerResponse> createPerson(org.springframework.web.reactive.function.server.ServerRequest)", route2.getHandlerMethod());
        ...
        assertEquals("org.test.webflux.HandlerImplementation", route3.getHandlerClass());
        assertEquals("public Mono<org.springframework.web.reactive.function.server.ServerResponse> listPeople(org.springframework.web.reactive.function.server.ServerRequest)", route3.getHandlerMethod());
	}

	@Test
	void testFluxBuilderMultipleRoutesWithDifferentMethods() throws Exception {
		String routerMethod = """
			@Bean
			RouterFunction<ServerResponse> multipleRoutes() {
				HandlerImplementation handler = new HandlerImplementation();
	...
	@Test
	void testFluxStaticNestedRoutes() throws Exception {
		String routerMethod = """
			@Bean
        ...
        assertEquals("org.test.webflux.HandlerImplementation", route2.getHandlerClass());
        assertEquals("public Mono<org.springframework.web.reactive.function.server.ServerResponse> listPeople(org.springframework.web.reactive.function.server.ServerRequest)", route2.getHandlerMethod());
        ...
        assertEquals("org.test.webflux.HandlerImplementation", route3.getHandlerClass());
        assertEquals("public Mono<org.springframework.web.reactive.function.server.ServerResponse> createPerson(org.springframework.web.reactive.function.server.ServerRequest)", route3.getHandlerMethod());
	}

	@Test
	void testFluxStaticNestedRoutesWithAssigment() throws Exception {
		String routerMethod = """
			@Bean
			RouterFunction<ServerResponse> nestedRoute() {
				HandlerImplementation handler = new HandlerImplementation();

				RouterFunction<ServerResponse> route = nest(accept(APPLICATION_JSON),
					nest(path("/person"),
						route(GET("/{id}"), handler::getPerson)
						.andRoute(method(HttpMethod.GET), handler::listPeople)
					).andRoute(POST("/").and(contentType(APPLICATION_JSON)), handler::createPerson));
	...
	@Test
	void testFluxBuilderNestedRoutes() throws Exception {
		String routerMethod = """
			@Bean
			RouterFunction<ServerResponse> nestedRoute() {
			    HandlerImplementation handler = new HandlerImplementation();
	...
	@Test
	void testFluxStaticComplicatedNestedRoutes() throws Exception {
		String routerMethod = """
			@Bean
        ...
        assertEquals("org.test.webflux.HandlerImplementation", route3.getHandlerClass());
        assertEquals("public Mono<org.springframework.web.reactive.function.server.ServerResponse> getPerson(org.springframework.web.reactive.function.server.ServerRequest)", route3.getHandlerMethod());
        ...
        assertEquals("org.test.webflux.HandlerImplementation", route4.getHandlerClass());
        assertEquals("public Mono<org.springframework.web.reactive.function.server.ServerResponse> getPerson(org.springframework.web.reactive.function.server.ServerRequest)", route4.getHandlerMethod());
        ...
        assertEquals("org.test.webflux.HandlerImplementation", route5.getHandlerClass());
        assertEquals("public Mono<org.springframework.web.reactive.function.server.ServerResponse> createPerson(org.springframework.web.reactive.function.server.ServerRequest)", route5.getHandlerMethod());
        ...
        assertEquals("org.test.webflux.HandlerImplementation", route6.getHandlerClass());
        assertEquals("public Mono<org.springframework.web.reactive.function.server.ServerResponse> deletePerson(org.springframework.web.reactive.function.server.ServerRequest)", route6.getHandlerMethod());
	}

	@Test
	void testFluxBuilderComplicatedNestedRoutes() throws Exception {
		String routerMethod = """
			@Bean
			RouterFunction<ServerResponse> complicatedNested() {
			    HandlerImplementation handler = new HandlerImplementation();
	...
	private Bean indexRouterMethod(String beanName, String routerMethod) throws Exception {
		String source = """
			...
			import org.test.webflux.HandlerImplementation;
