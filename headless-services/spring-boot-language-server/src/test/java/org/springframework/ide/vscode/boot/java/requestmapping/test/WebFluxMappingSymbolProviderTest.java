...
public class WebFluxMappingSymbolProviderTest {
    ...
    void testRoutesMappingSymbols() throws Exception {
        ...
        assertTrue(containsSymbol(symbols, "@/quotes -- GET - Accept: application/x-ndjson", docUri, 26, 5, 26, 117));
        ...
        WebfluxHandlerMethodIndexElement handlerElement3 = getWebfluxIndexElements(children, "/quotes", "GET").get(1);
        ...
        assertEquals("[APPLICATION_NDJSON]", Arrays.toString(handlerElement3.getAcceptTypes()));
        ...
        WebfluxHandlerMethodIndexElement handlerElement4 = getWebfluxIndexElements(children, "/quotes", "GET").get(0);
    ...
    void testNestedRoutesMappingSymbols2() throws Exception {
        ...
        assertTrue(containsSymbol(symbols, "@/ -- POST - Accept: application/json - Content-Type: application/pdf,application/json", docUri, 31, 6, 31, 117));
        assertTrue(containsSymbol(symbols, "@/person -- HEAD,GET - Accept: application/json,text/plain", docUri, 30, 7, 30, 113));
        ...
        assertEquals("[POST]", Arrays.toString(handlerElement2.getHttpMethods()));
        assertEquals("[APPLICATION_PDF, APPLICATION_JSON]", Arrays.toString(handlerElement2.getContentTypes()));
        ...
        assertEquals("/person", handlerElement3.getPath());
        assertEquals("[HEAD, GET]", Arrays.toString(handlerElement3.getHttpMethods()));
        assertEquals(0, handlerElement3.getContentTypes().length);
        assertEquals("[APPLICATION_JSON, TEXT_PLAIN]", Arrays.toString(handlerElement3.getAcceptTypes()));
